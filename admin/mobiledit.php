							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">cc<span style="color:red">*</span></label>
											<div class="col-sm-4">
												<input type="text" name="cc" class="form-control" value="<?php echo htmlentities($result['cc']                                                  );?>" required>
											</div>
									</div>
                                    ...
                                    <label class="col-sm-2 control-label">Kapasitas Tempat Duduk<span style="color:red">*</span></label>
                                        ...
                                        <label class="col-sm-2 control-label">Transmisi<span style="color:red">*</span></label>
											<div class="col-sm-4">
