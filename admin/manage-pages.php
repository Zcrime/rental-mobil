							...
							<div class="col-md-10">
								<div class="panel panel-default">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="menu1" class="form-control" onChange="MM_jumpMenu('parent',this,0)">
													  ...
													  <option value="manage-pages.php?type=faqs">Syarat dan Ketentuan</option>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea class="form-control" rows="5" cols="50" name="pagedetails" id="pagedetails" placeholder="Package Details" required>
											<?php 
												$pagetype=$_GET['type'];
