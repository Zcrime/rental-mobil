	<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">			
				<li class="ts-label">Administrator</li>
		   ...
		   <!-- <li><a href="driver.php"><i class="fa fa-money"></i> Biaya Driver</a></li> 
				...
				<li><a href="manage-conactusquery.php"><i class="fa fa-phone"></i> Pesanan</a></li>
				<li><a href="manage-pages.php"><i class="fa fa-gear"></i> Kelola Halaman</a></li>
                <li><a href="galery.php"><i class="fa fa-gear"></i> Galery</a></li>
