        ...
        <div class="main_features">
          <ul>         
            ...
            <li> <i class="fa fa-car" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result['transmisi']);?></h5>
              <p></p>
            </li>
            <li> <i class="fa fa-car" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result['cc']);?></h5>
              <p>CC</p>
            </li>
          </ul>
        </div>
          ...
          <form method="get" action="booking.php">
            ...
            <div class="form-group">
              <input type="date" class="form-control" name="todate" placeholder="To Date(dd/mm/yyyy)" required>
				...
				<a href="https://wa.me/message/F5OGSOQEOEFXE1" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Sewa Sekarang</a>
          </form>
        </div>
      </aside>
      <!--/Side-Bar--> 
